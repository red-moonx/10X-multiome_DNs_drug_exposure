# ===========================================
# Script Title: 241114_ATAC_Memory_kmeans_Preparation.R
# Author: Luna Zea Redondo
# Date: 2024-11-14
# Description:
#   This script prepares ATAC-seq Differential Accessible Regions (DARs)
#   for time series analysis and memory-related clustering analysis in VTA-DNs.
#
#   Specifically, it:
#     - Subsets late-stage ATAC samples (saline, 24h, 14d)
#     - Exports peak matrices for k-means clustering (h5Seurat → h5ad)
#     - Defines late DARs for clustering
#     - Loads manually curated k-means cluster assignments
#     - Classifies DARs into memory categories:
#           * recovered
#           * memory
#           * delayed
#           * transient
#     - Assigns directionality (up/down)
#     - Generates a final DAR memory annotation table
#
#   Outputs:
#     - h5ad files for clustering (late and all timepoints)
#     - 241114_DAR_complete_results_kmeans.tsv
#
# ===========================================
...
# 1.1 Subset late samples (saline, 24h, 14d)
...
# 1.2 Generate peak-only Seurat object
...
# 1.3 Export h5Seurat → h5ad for clustering
...
# 1.4 Load late DARs (241113 version)
...
# 1.5 Prepare full timepoint dataset (for plotting)
...
# save.image("241115.kmeans_ATAC_first_part.rds")



# ========== 2. K-means Memory Classification ==========
...
# ========== 3. Final Output ==========
# Write final annotated DAR table:
