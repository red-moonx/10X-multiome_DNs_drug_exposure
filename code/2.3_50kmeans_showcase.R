...
setwd("/fast/AG_Pombo/luna/2023_vta_multiome/2024/1_GEX/8_240510_GEX_memory_only_v2/12_showcase_50K")

# ========== 1. Load DEG Results ==========
# Load kmeans-clustered DEGs
DEG_complete <- readRDS("/fast/AG_Pombo/luna/2023_vta_multiome/2024/1_GEX/8_240510_GEX_memory_only_v2/250205_DEG_complete_results_kmeans.corrected.4243.rds")
DEGs_kmeans <- DEG_complete %>% dplyr::select(gene, kmeans_cluster)
...
DEGs_kmeans_classifier <- DEG_complete %>% 
  dplyr::select(gene, kmeans_cluster, is_CAG, is_addiction, is_psychiatric)
...
# plot_name <- "chapter2_50kmeans_classifier"
