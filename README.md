...
### Overview  
Drugs of abuse hijack the brain’s reward circuitry, reinforcing drug-taking behavior and driving addiction. Dopaminergic neurons (DNs) in the ventral tegmental area (VTA) are among the first to respond to cocaine exposure and play a central role in this process. While the effects of a single exposure are generally considered to be transient, it remains unclear whether a single cocaine dose can induce lasting gene regulatory changes. In this project, I investigated genome-wide changes in transcription and chromatin accessibility in dopamine neurons (DNs) from the VTA following a single cocaine exposure, using paired single-nucleus ATAC-seq and RNA-seq across immediate (0–8h), short-term (24h), and long-term (14d) time points.
